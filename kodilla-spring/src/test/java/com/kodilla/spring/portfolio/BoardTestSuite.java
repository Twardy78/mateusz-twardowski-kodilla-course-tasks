...
public class BoardTestSuite {
    ...
    public void testAddTask() {
        //Given
        //When
        board.getToDoList().addTask("Replace rear glass.");
        board.getToDoList().addTask("Replace rear tires.");
        board.getToDoList().addTask("Install new front lights.");
        board.getInProgressList().addTask("Paint front bumper.");
        board.getInProgressList().addTask("Repair the clutch hydraulic pump.");
        board.getDoneList().addTask("Replace front braking disks.");
